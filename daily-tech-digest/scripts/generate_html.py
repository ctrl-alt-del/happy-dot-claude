...
def render_stats(stats, daily_keywords):
    ...
    labels = {
        "us_news": "US News", "china_news": "China News",
        "github_trending": "GitHub", "hf_trending": "HuggingFace",
        "arxiv_top": "arXiv (Top Inst.)", "arxiv_other": "arXiv (Other)",
    }
...
<header class="site-header">
  <div class="header-inner">
    <div class="header-left">
      <h1 class="site-title">Daily AI & Tech Digest</h1>
...
<footer>
  {sources_html}
  <div class="footer-note">Generated {datetime.now().strftime("%Y-%m-%d %H:%M")} &mdash; daily-tech-digest</div>
</footer>
{embedded}
{JS}
</body>
